...
This dashboard provides insights into road accidents for the years 2021 and 2022. The key features include:
...
- **Casualties by Vehicle Type**: 
  - Display the total number and percentage of casualties caused by the vehicle type that results in the highest casualties.
  - Provide a breakdown of total casualties by different vehicle types (cars, motorcycles, bicycles, trucks, others).
